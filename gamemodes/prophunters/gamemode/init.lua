...
GM.RoundLimit = CreateConVar("ph_roundlimit", 100000, bit.bor(FCVAR_NOTIFY), "Number of rounds before mapvote" )
GM.StartWaitTime = CreateConVar("ph_mapstartwait", 31, bit.bor(FCVAR_NOTIFY), "Number of seconds to wait for players on map start before starting round" )
